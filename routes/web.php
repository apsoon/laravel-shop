...
Route::group(['middleware' => 'web', 'namespace' => 'Mapi'], function () {
    ...
    Route::POST("sku/delete", "SkuMapi@delete");
...
//    Route::GET("attrValue/list", "AttrMapi@valueList");
    ...
    Route::GET("spec/delete-spu", "SpecMapi@deleteBySpu");
    ...
    Route::GET("after/callback", "AfterSaleMapi@callback");
    Route::POST("after/callback", "AfterSaleMapi@callback");
